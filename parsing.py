'''Вебскрейпинг - это технология получения данных c веб страницы путем извлечения'''

''' Парсинг -> анализ данных, автоматический сбор данных и их структурирование'''


# requests -> отправляет запрос на сайт, и мы получаем html код страницы

# lxml -> разбирается в html, выступает в роли парсера 
# (анализирует, разбирает информацию на мелкие части для Beautifulsoup4)

# Beautifulsoup4 -> помагает извлекать информацию из html. 
# Позволяет обращаться к определенным тегам и вытаскивать из них данные
